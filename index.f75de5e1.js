...
const formattedAveragePopulation = averagePopulationCount.toLocaleString("en-US");
document.querySelector(".total-population").innerHTML = formattedTotalPopulation;
document.querySelector(".average-population").innerHTML = formattedAveragePopulation;
